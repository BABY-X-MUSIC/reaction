...
✍️ To view the emojis I can use, simply type /reactions. To create your own auto reaction bot, head over to: [Auto-Reaction-Bot on GitHub](https://t.me/UFC_NETWORK).
...
<button class="button githubBtn" onclick="window.location='https://github.com/BABY-X-MUSIC/reaction'">Open Source 🌱</button>

<div style="margin: 5px;">
  <a class="github-button" href="https://github.com/BABY-X-MUSIC/reaction" data-size="large" data-show-count="true">Star</a>
  <a class="github-button" href="https://github.com/BABY-X-MUSIC/reaction/fork" data-size="large" data-show-count="true">Fork</a>
</div>
<div>
  <a class="github-button" href="https://github.com/BABY-X-MUSIC/reaction" data-size="large">Follow @ll_ZIDDI_SHAYAR_ll</a>
</div>
</body>
</html>
`;
